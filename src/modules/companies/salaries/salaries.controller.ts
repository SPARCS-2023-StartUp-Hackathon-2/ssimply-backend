...
export class SalariesController {
    ...
    async create(@Body() dto: SalaryCreateRequestDto): Promise<CommonResponseDto<SalaryCreateRequestDto>> {
        return await this.salariesService.create(dto);
    }
    ...
    async getList(@Req() req): Promise<CommonResponseDto<SalaryGetListResponseDto>> {
    ...
    async get(@Param('id') id: number): Promise<CommonResponseDto<SalaryGetResponseDto>> {
